...
void GPIO_Init(void)
{
	(((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIODIR |= (uint32_t)((1<<1)|(1<<2)));
	(((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIODIR &= ~(uint32_t)((1<<1)));
	(((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOMASK &= ~(uint32_t)((1<<1)));
	
	(((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIOCLR = (uint32_t)((1<<1)));
	
	
	(((LPC_GPIOINT_TypeDef *) ((0x40000000UL) + 0x28080) )->IO2IntEnF = (uint32_t)((1<<1)));
	(((LPC_GPIOINT_TypeDef *) ((0x40000000UL) + 0x28080) )->IO2IntStatF);
}
