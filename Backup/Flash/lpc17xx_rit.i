#line 1 "Lib\\Drivers\\source\\lpc17xx_rit.c"
...
#line 1 ".\\Lib\\Drivers\\include\\lpc17xx_rit.h"
...
#line 44 ".\\Lib\\Drivers\\include\\lpc17xx_rit.h"
...
#line 45 ".\\Lib\\Drivers\\include\\lpc17xx_rit.h"
...
#line 39 "Lib\\Drivers\\source\\lpc17xx_rit.c"
...
#line 40 "Lib\\Drivers\\source\\lpc17xx_rit.c"
...
#line 49 "Lib\\Drivers\\source\\lpc17xx_rit.c"
...
void RIT_Init(LPC_RIT_TypeDef *RITx)
{
	(((((uint32_t *)RITx)==((uint32_t *)((LPC_RIT_TypeDef *) ((0x40080000UL) + 0x30000) )))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_rit.c", 67));
	CLKPWR_ConfigPPWR (((uint32_t)(1<<16)), ENABLE);
...
void RIT_DeInit(LPC_RIT_TypeDef *RITx)
{
	(((((uint32_t *)RITx)==((uint32_t *)((LPC_RIT_TypeDef *) ((0x40080000UL) + 0x30000) )))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_rit.c", 86));

	
	CLKPWR_ConfigPPWR (((uint32_t)(1<<16)), DISABLE);
...
void RIT_TimerConfig(LPC_RIT_TypeDef *RITx, uint32_t time_interval)
{
	...
	(((((uint32_t *)RITx)==((uint32_t *)((LPC_RIT_TypeDef *) ((0x40080000UL) + 0x30000) )))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_rit.c", 106));

	
	clock_rate = CLKPWR_GetPCLK(((uint32_t)(58)));
...
void RIT_Cmd(LPC_RIT_TypeDef *RITx, FunctionalState NewState)
{
	(((((uint32_t *)RITx)==((uint32_t *)((LPC_RIT_TypeDef *) ((0x40080000UL) + 0x30000) )))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_rit.c", 136));
	((((NewState==DISABLE) || (NewState==ENABLE))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_rit.c", 137));

	
	if(NewState==ENABLE)
	{
		RITx->RICTRL |= ((uint32_t) (1<<3));
	}
	else
	{
		RITx->RICTRL &= ~((uint32_t) (1<<3));
...
void RIT_TimerDebugCmd(LPC_RIT_TypeDef *RITx, FunctionalState NewState)
{
	(((((uint32_t *)RITx)==((uint32_t *)((LPC_RIT_TypeDef *) ((0x40080000UL) + 0x30000) )))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_rit.c", 160));
	((((NewState==DISABLE) || (NewState==ENABLE))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_rit.c", 161));

	
	if(NewState==ENABLE)
	{
		RITx->RICTRL |= ((uint32_t) (1<<2));
	}
	else
	{
		RITx->RICTRL &= ~((uint32_t) (1<<2));
...
{
	IntStatus result;
	(((((uint32_t *)RITx)==((uint32_t *)((LPC_RIT_TypeDef *) ((0x40080000UL) + 0x30000) )))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_rit.c", 181));
	if((RITx->RICTRL&((uint32_t) (1)))==1)	result= SET;
	else return RESET;
	
	RITx->RICTRL |= ((uint32_t) (1));
	return result;
}
