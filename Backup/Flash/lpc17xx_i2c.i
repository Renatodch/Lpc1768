...
#line 1 ".\\Lib\\Drivers\\include\\lpc17xx_i2c.h"
...
#line 44 ".\\Lib\\Drivers\\include\\lpc17xx_i2c.h"
...
#line 45 ".\\Lib\\Drivers\\include\\lpc17xx_i2c.h"
...
#line 278 ".\\Lib\\Drivers\\include\\lpc17xx_i2c.h"
...
#line 40 "Lib\\Drivers\\source\\lpc17xx_i2c.c"
...
#line 41 "Lib\\Drivers\\source\\lpc17xx_i2c.c"
#line 1 ".\\Lib\\Drivers\\include\\lpc17xx_pinsel.h"
...
#line 44 ".\\Lib\\Drivers\\include\\lpc17xx_pinsel.h"
#line 45 ".\\Lib\\Drivers\\include\\lpc17xx_pinsel.h"
...
#line 108 ".\\Lib\\Drivers\\include\\lpc17xx_pinsel.h"
...
#line 42 "Lib\\Drivers\\source\\lpc17xx_i2c.c"
...
#line 52 "Lib\\Drivers\\source\\lpc17xx_i2c.c"
...
static int32_t I2C_getNum(LPC_I2C_TypeDef *I2Cx){
	if (I2Cx == ((LPC_I2C_TypeDef *) ((0x40000000UL) + 0x1C000) )) {
		return (0);
	} else if (I2Cx == ((LPC_I2C_TypeDef *) ((0x40000000UL) + 0x5C000) )) {
		return (1);
	} else if (I2Cx == ((LPC_I2C_TypeDef *) ((0x40080000UL) + 0x20000) )) {
		return (2);
	}
	return (-1);
}
...
static uint32_t I2C_Start (LPC_I2C_TypeDef *I2Cx)
{
	...
	I2Cx->I2CONCLR = ((1<<3))|((1<<4))|((1<<5));

	
	I2Cx->I2CONSET = ((0x20));

	
	while (!(I2Cx->I2CONSET & ((0x08))));
	I2Cx->I2CONCLR = ((1<<5));
	return (I2Cx->I2STAT & ((0xF8)));
}
...
static void I2C_Stop (LPC_I2C_TypeDef *I2Cx)
{
	...
	if (I2Cx->I2CONSET & ((0x20)))
	{
		I2Cx->I2CONCLR = ((1<<5));
	}

	I2Cx->I2CONSET = ((0x10))|((0x04));
...
static uint32_t I2C_SendByte (LPC_I2C_TypeDef *I2Cx, uint8_t databyte)
{
	uint32_t CodeStatus = I2Cx->I2STAT & ((0xF8));
...
static uint32_t I2C_GetByte (LPC_I2C_TypeDef *I2Cx, uint8_t *retdat, Bool ack)
{
	*retdat = (uint8_t) (I2Cx->I2DAT & ((0xFF)));
...
static void I2C_SetClock (LPC_I2C_TypeDef *I2Cx, uint32_t target_clock)
{
	...
	((((((uint32_t *)I2Cx)==((uint32_t *)((LPC_I2C_TypeDef *) ((0x40000000UL) + 0x1C000) ))) || (((uint32_t *)I2Cx)==((uint32_t *)((LPC_I2C_TypeDef *) ((0x40000000UL) + 0x5C000) ))) || (((uint32_t *)I2Cx)==((uint32_t *)((LPC_I2C_TypeDef *) ((0x40080000UL) + 0x20000) ))))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_i2c.c", 247));

	
	if (I2Cx == ((LPC_I2C_TypeDef *) ((0x40000000UL) + 0x1C000) ))
	{
		temp = CLKPWR_GetPCLK (((uint32_t)(14))) / target_clock;
	}
	else if (I2Cx == ((LPC_I2C_TypeDef *) ((0x40000000UL) + 0x5C000) ))
	{
		temp = CLKPWR_GetPCLK (((uint32_t)(38))) / target_clock;
	}
	else if (I2Cx == ((LPC_I2C_TypeDef *) ((0x40080000UL) + 0x20000) ))
	{
		temp = CLKPWR_GetPCLK (((uint32_t)(52))) / target_clock;
	}
...
void I2C_Init(LPC_I2C_TypeDef *I2Cx, uint32_t clockrate)
{
	((((((uint32_t *)I2Cx)==((uint32_t *)((LPC_I2C_TypeDef *) ((0x40000000UL) + 0x1C000) ))) || (((uint32_t *)I2Cx)==((uint32_t *)((LPC_I2C_TypeDef *) ((0x40000000UL) + 0x5C000) ))) || (((uint32_t *)I2Cx)==((uint32_t *)((LPC_I2C_TypeDef *) ((0x40080000UL) + 0x20000) ))))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_i2c.c", 287));

	if (I2Cx==((LPC_I2C_TypeDef *) ((0x40000000UL) + 0x1C000) ))
	{
		 
		CLKPWR_ConfigPPWR (((uint32_t)(1<<7)), ENABLE);
		
 
		CLKPWR_SetPCLKDiv(((uint32_t)(14)), ((uint32_t)(2)));
	}
	else if (I2Cx==((LPC_I2C_TypeDef *) ((0x40000000UL) + 0x5C000) ))
	{
		 
		CLKPWR_ConfigPPWR (((uint32_t)(1<<19)), ENABLE);
		
 
		CLKPWR_SetPCLKDiv(((uint32_t)(38)), ((uint32_t)(2)));
	}
	else if (I2Cx==((LPC_I2C_TypeDef *) ((0x40080000UL) + 0x20000) ))
	{
		 
		CLKPWR_ConfigPPWR (((uint32_t)(1<<26)), ENABLE);
		
 
		CLKPWR_SetPCLKDiv(((uint32_t)(52)), ((uint32_t)(2)));
	}
	else {
...
void I2C_DeInit(LPC_I2C_TypeDef* I2Cx)
{
	((((((uint32_t *)I2Cx)==((uint32_t *)((LPC_I2C_TypeDef *) ((0x40000000UL) + 0x1C000) ))) || (((uint32_t *)I2Cx)==((uint32_t *)((LPC_I2C_TypeDef *) ((0x40000000UL) + 0x5C000) ))) || (((uint32_t *)I2Cx)==((uint32_t *)((LPC_I2C_TypeDef *) ((0x40080000UL) + 0x20000) ))))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_i2c.c", 335));
	...
	if (I2Cx==((LPC_I2C_TypeDef *) ((0x40000000UL) + 0x1C000) ))
	{
		...
		CLKPWR_ConfigPPWR (((uint32_t)(1<<7)), DISABLE);
	}
	else if (I2Cx==((LPC_I2C_TypeDef *) ((0x40000000UL) + 0x5C000) ))
	{
		 
		CLKPWR_ConfigPPWR (((uint32_t)(1<<19)), DISABLE);
	}
	else if (I2Cx==((LPC_I2C_TypeDef *) ((0x40080000UL) + 0x20000) ))
	{
		 
		CLKPWR_ConfigPPWR (((uint32_t)(1<<26)), DISABLE);
	}
}
...
void I2C_Cmd(LPC_I2C_TypeDef* I2Cx, en_I2C_Mode Mode,  FunctionalState NewState)
{
	((((NewState==DISABLE) || (NewState==ENABLE))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_i2c.c", 368));
	((((((uint32_t *)I2Cx)==((uint32_t *)((LPC_I2C_TypeDef *) ((0x40000000UL) + 0x1C000) ))) || (((uint32_t *)I2Cx)==((uint32_t *)((LPC_I2C_TypeDef *) ((0x40000000UL) + 0x5C000) ))) || (((uint32_t *)I2Cx)==((uint32_t *)((LPC_I2C_TypeDef *) ((0x40080000UL) + 0x20000) ))))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_i2c.c", 369));
...
int32_t I2C_SlaveHanleStates(LPC_I2C_TypeDef  *I2Cx, uint32_t CodeStatus, I2C_S_SETUP_Type *TransferCfg)
{
	...
	switch (CodeStatus)
	{
		...
		case ((0x80)):
			...
			if ((TransferCfg->rx_count < TransferCfg->rx_length) && (TransferCfg->rx_data != ((void*) 0)))
			{
		...
		case ((0xB8)):
			...
			if ((TransferCfg->tx_count < TransferCfg->tx_length) && (TransferCfg->tx_data != ((void*) 0)))
			{
				I2Cx->I2DAT = *txdat++;
		...
		while(1)	
		{
			...
			if((Ret & 0x10000000))
			{
				...
				if (TransferCfg->retransmissions_count > TransferCfg->retransmissions_max){
						...
						TransferCfg->status = CodeStatus | (1<<9);
						goto error;
					} else {
						goto retry;
					}
...
s_end_stage:
		...
		TransferCfg->status = CodeStatus | (1<<10);
		return SUCCESS;
...
{
	uint32_t tmp;
	((((((uint32_t *)I2Cx)==((uint32_t *)((LPC_I2C_TypeDef *) ((0x40000000UL) + 0x1C000) ))) || (((uint32_t *)I2Cx)==((uint32_t *)((LPC_I2C_TypeDef *) ((0x40000000UL) + 0x5C000) ))) || (((uint32_t *)I2Cx)==((uint32_t *)((LPC_I2C_TypeDef *) ((0x40080000UL) + 0x20000) ))))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_i2c.c", 1148));
	(((OwnSlaveAddrConfigStruct->SlaveAddrChannel<=3)) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_i2c.c", 1149));
	((((OwnSlaveAddrConfigStruct->GeneralCallState==DISABLE) || (OwnSlaveAddrConfigStruct->GeneralCallState==ENABLE))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_i2c.c", 1150));

	tmp = (((uint32_t)(OwnSlaveAddrConfigStruct->SlaveAddr_7bit << 1)) 			| ((OwnSlaveAddrConfigStruct->GeneralCallState == ENABLE) ? 0x01 : 0x00))& ((0xFF));

	switch (OwnSlaveAddrConfigStruct->SlaveAddrChannel)
	{
	case 0:
		I2Cx->I2ADR0 = tmp;
		I2Cx->I2MASK0 = (((uint32_t) (OwnSlaveAddrConfigStruct->SlaveAddrMaskValue)&0xFE));

		break;
	case 1:
		I2Cx->I2ADR1 = tmp;
		I2Cx->I2MASK1 = (((uint32_t) (OwnSlaveAddrConfigStruct->SlaveAddrMaskValue)&0xFE));

		break;
	case 2:
		I2Cx->I2ADR2 = tmp;
		I2Cx->I2MASK2 = (((uint32_t) (OwnSlaveAddrConfigStruct->SlaveAddrMaskValue)&0xFE));

		break;
	case 3:
		I2Cx->I2ADR3 = tmp;
		I2Cx->I2MASK3 = (((uint32_t) (OwnSlaveAddrConfigStruct->SlaveAddrMaskValue)&0xFE));
...
void I2C_MonitorModeConfig(LPC_I2C_TypeDef *I2Cx, uint32_t MonitorCfgType, FunctionalState NewState)
{
	((((((uint32_t *)I2Cx)==((uint32_t *)((LPC_I2C_TypeDef *) ((0x40000000UL) + 0x1C000) ))) || (((uint32_t *)I2Cx)==((uint32_t *)((LPC_I2C_TypeDef *) ((0x40000000UL) + 0x5C000) ))) || (((uint32_t *)I2Cx)==((uint32_t *)((LPC_I2C_TypeDef *) ((0x40080000UL) + 0x20000) ))))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_i2c.c", 1200));
	((((MonitorCfgType==((1<<1))) || (((1<<2))))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_i2c.c", 1201));
	((((NewState==DISABLE) || (NewState==ENABLE))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_i2c.c", 1202));
	...
	{
		I2Cx->MMCTRL &= (~MonitorCfgType) & ((0x07));
	}
}
...
void I2C_MonitorModeCmd(LPC_I2C_TypeDef *I2Cx, FunctionalState NewState)
{
	((((((uint32_t *)I2Cx)==((uint32_t *)((LPC_I2C_TypeDef *) ((0x40000000UL) + 0x1C000) ))) || (((uint32_t *)I2Cx)==((uint32_t *)((LPC_I2C_TypeDef *) ((0x40000000UL) + 0x5C000) ))) || (((uint32_t *)I2Cx)==((uint32_t *)((LPC_I2C_TypeDef *) ((0x40080000UL) + 0x20000) ))))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_i2c.c", 1228));
	((((NewState==DISABLE) || (NewState==ENABLE))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_i2c.c", 1229));
	...
	{
		I2Cx->MMCTRL &= (~((1<<0))) & ((0x07));
		I2Cx->I2CONCLR = ((1<<3)) | ((1<<5)) | ((1<<2));
	}
...
uint8_t I2C_MonitorGetDatabuffer(LPC_I2C_TypeDef *I2Cx)
{
	((((((uint32_t *)I2Cx)==((uint32_t *)((LPC_I2C_TypeDef *) ((0x40000000UL) + 0x1C000) ))) || (((uint32_t *)I2Cx)==((uint32_t *)((LPC_I2C_TypeDef *) ((0x40000000UL) + 0x5C000) ))) || (((uint32_t *)I2Cx)==((uint32_t *)((LPC_I2C_TypeDef *) ((0x40080000UL) + 0x20000) ))))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_i2c.c", 1263));
