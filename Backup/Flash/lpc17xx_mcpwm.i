...
#line 1 ".\\Lib\\Drivers\\include\\lpc17xx_mcpwm.h"
...
#line 44 ".\\Lib\\Drivers\\include\\lpc17xx_mcpwm.h"
...
#line 45 ".\\Lib\\Drivers\\include\\lpc17xx_mcpwm.h"
...
#line 76 ".\\Lib\\Drivers\\include\\lpc17xx_mcpwm.h"
...
#line 128 ".\\Lib\\Drivers\\include\\lpc17xx_mcpwm.h"
...
#line 199 ".\\Lib\\Drivers\\include\\lpc17xx_mcpwm.h"
...
#line 40 "Lib\\Drivers\\source\\lpc17xx_mcpwm.c"
...
#line 41 "Lib\\Drivers\\source\\lpc17xx_mcpwm.c"
...
#line 50 "Lib\\Drivers\\source\\lpc17xx_mcpwm.c"
...
void MCPWM_Init(LPC_MCPWM_TypeDef *MCPWMx)
{
	...
	CLKPWR_ConfigPPWR (((uint32_t)(1<<17)), ENABLE);
	
 
	

	MCPWMx->MCCAP_CLR = ((0<=2) ? ((uint32_t)(1<<0)) : (0)) | ((1<=2) ? ((uint32_t)(1<<1)) : (0)) | ((2<=2) ? ((uint32_t)(1<<2)) : (0));
	MCPWMx->MCINTFLAG_CLR = (((0>=0)&&(0<=2)) ? ((uint32_t)(1<<((0*4)+0))) : (0)) | (((1>=0)&&(1<=2)) ? ((uint32_t)(1<<((1*4)+0))) : (0)) | (((2>=0)&&(2<=2)) ? ((uint32_t)(1<<((2*4)+0))) : (0)) 							| (((0>=0)&&(0<=2)) ? ((uint32_t)(1<<((0*4)+1))) : (0)) | (((1>=0)&&(1<=2)) ? ((uint32_t)(1<<((1*4)+1))) : (0)) | (((2>=0)&&(2<=2)) ? ((uint32_t)(1<<((2*4)+1))) : (0)) 							| (((0>=0)&&(0<=2)) ? ((uint32_t)(1<<((0*4)+2))) : (0)) | (((1>=0)&&(1<=2)) ? ((uint32_t)(1<<((1*4)+2))) : (0)) | (((2>=0)&&(2<=2)) ? ((uint32_t)(1<<((2*4)+2))) : (0));


	MCPWMx->MCINTEN_CLR = (((0>=0)&&(0<=2)) ? ((uint32_t)(1<<((0*4)+0))) : (0)) | (((1>=0)&&(1<=2)) ? ((uint32_t)(1<<((1*4)+0))) : (0)) | (((2>=0)&&(2<=2)) ? ((uint32_t)(1<<((2*4)+0))) : (0)) 							| (((0>=0)&&(0<=2)) ? ((uint32_t)(1<<((0*4)+1))) : (0)) | (((1>=0)&&(1<=2)) ? ((uint32_t)(1<<((1*4)+1))) : (0)) | (((2>=0)&&(2<=2)) ? ((uint32_t)(1<<((2*4)+1))) : (0)) 							| (((0>=0)&&(0<=2)) ? ((uint32_t)(1<<((0*4)+2))) : (0)) | (((1>=0)&&(1<=2)) ? ((uint32_t)(1<<((1*4)+2))) : (0)) | (((2>=0)&&(2<=2)) ? ((uint32_t)(1<<((2*4)+2))) : (0));
						...
						MCPWM_CHANNEL_CFG_Type * channelSetup)
{
	if (channelNum <= 2) {
		...
		if (channelSetup->channelType  ){
			MCPWMx->MCCON_SET = ((channelNum<=2) ? ((uint32_t)(1<<((channelNum*8)+1))) : (0));
		} else {
			MCPWMx->MCCON_CLR = ((channelNum<=2) ? ((uint32_t)(1<<((channelNum*8)+1))) : (0));
		}

		if (channelSetup->channelPolarity  ){
			MCPWMx->MCCON_SET = ((channelNum<=2) ? ((uint32_t)(1<<((channelNum*8)+2))) : (0));
		} else {
			MCPWMx->MCCON_CLR = ((channelNum<=2) ? ((uint32_t)(1<<((channelNum*8)+2))) : (0));
		}

		if (channelSetup->channelDeadtimeEnable  ){
			MCPWMx->MCCON_SET = ((channelNum<=2) ? ((uint32_t)(1<<((channelNum*8)+3))) : (0));
			MCPWMx->MCDEADTIME &= ~(((channelNum<=2) ? ((uint32_t)((0x3FF&0x3FF)<<(channelNum*10))) : (0)));
			MCPWMx->MCDEADTIME |= ((channelNum<=2) ? ((uint32_t)((channelSetup->channelDeadtimeValue&0x3FF)<<(channelNum*10))) : (0));
		} else {
			MCPWMx->MCCON_CLR = ((channelNum<=2) ? ((uint32_t)(1<<((channelNum*8)+3))) : (0));
		}

		if (channelSetup->channelUpdateEnable  ){
			MCPWMx->MCCON_CLR = ((channelNum<=2) ? ((uint32_t)(1<<((channelNum*8)+4))) : (0));
		} else {
			MCPWMx->MCCON_SET = ((channelNum<=2) ? ((uint32_t)(1<<((channelNum*8)+4))) : (0));
		}
	}
}
						...
						MCPWM_CAPTURE_CFG_Type *captureConfig)
{
	if (channelNum <= 2) {
		...
		if (captureConfig->captureFalling  ) {
			MCPWMx->MCCAPCON_SET = (((captureConfig->captureChannel<=2)&&(channelNum<=2)) ? ((uint32_t)(1<<((captureConfig->captureChannel*6)+(channelNum*2)+1))) : (0));
		} else {
			MCPWMx->MCCAPCON_CLR = (((captureConfig->captureChannel<=2)&&(channelNum<=2)) ? ((uint32_t)(1<<((captureConfig->captureChannel*6)+(channelNum*2)+1))) : (0));
		}

		if (captureConfig->captureRising  ) {
			MCPWMx->MCCAPCON_SET = (((captureConfig->captureChannel<=2)&&(channelNum<=2)) ? ((uint32_t)(1<<((captureConfig->captureChannel*6)+(channelNum*2)+0))) : (0));
		} else {
			MCPWMx->MCCAPCON_CLR = (((captureConfig->captureChannel<=2)&&(channelNum<=2)) ? ((uint32_t)(1<<((captureConfig->captureChannel*6)+(channelNum*2)+0))) : (0));
		}

		if (captureConfig->timerReset  ){
			MCPWMx->MCCAPCON_SET = ((captureConfig->captureChannel<=2) ? ((uint32_t)(1<<(18+(captureConfig->captureChannel)))) : (0));
		} else {
			MCPWMx->MCCAPCON_CLR = ((captureConfig->captureChannel<=2) ? ((uint32_t)(1<<(18+(captureConfig->captureChannel)))) : (0));
		}

		if (captureConfig->hnfEnable  ){
			MCPWMx->MCCAPCON_SET = ((channelNum<=2) ? ((uint32_t)(1<<(21+(channelNum)))) : (0));
		} else {
			MCPWMx->MCCAPCON_CLR = ((channelNum<=2) ? ((uint32_t)(1<<(21+(channelNum)))) : (0));
		}
	}
}
...
void MCPWM_ClearCapture(LPC_MCPWM_TypeDef *MCPWMx, uint32_t captureChannel)
{
	MCPWMx->MCCAP_CLR = ((captureChannel<=2) ? ((uint32_t)(1<<captureChannel)) : (0));
}
					...
					uint32_t countMode, MCPWM_COUNT_CFG_Type *countConfig)
{
	if (channelNum <= 2) {
		if (countMode  ){
			MCPWMx->MCCNTCON_SET = ((channelNum<=2) ? ((uint32_t)(1<<(29+channelNum))) : (0));
			if (countConfig->countFalling  ) {
				MCPWMx->MCCNTCON_SET = (((countConfig->counterChannel<=2)&&(channelNum<=2)) ? ((uint32_t)(1<<((6*countConfig->counterChannel)+(2*channelNum)+1))) : (0));
			} else {
				MCPWMx->MCCNTCON_CLR = (((countConfig->counterChannel<=2)&&(channelNum<=2)) ? ((uint32_t)(1<<((6*countConfig->counterChannel)+(2*channelNum)+1))) : (0));
			}
			if (countConfig->countRising  ) {
				MCPWMx->MCCNTCON_SET = (((countConfig->counterChannel<=2)&&(channelNum<=2)) ? ((uint32_t)(1<<((6*countConfig->counterChannel)+(2*channelNum)+0))) : (0));
			} else {
				MCPWMx->MCCNTCON_CLR = (((countConfig->counterChannel<=2)&&(channelNum<=2)) ? ((uint32_t)(1<<((6*countConfig->counterChannel)+(2*channelNum)+0))) : (0));
			}
		} else {
			MCPWMx->MCCNTCON_CLR = ((channelNum<=2) ? ((uint32_t)(1<<(29+channelNum))) : (0));
		}
	}
}
...
{
	uint32_t regVal = 0;
	regVal = (channel0 ? ((0<=2) ? ((uint32_t)(1<<((0*8)+0))) : (0)) : 0) | (channel1 ? ((1<=2) ? ((uint32_t)(1<<((1*8)+0))) : (0)) : 0) 				| (channel2 ? ((2<=2) ? ((uint32_t)(1<<((2*8)+0))) : (0)) : 0);
...
{
	if (acMode){
		MCPWMx->MCCON_SET = ((uint32_t)(1<<30));
	} else {
		MCPWMx->MCCON_CLR = ((uint32_t)(1<<30));
	}
}
...
{
	if (dcMode){
		MCPWMx->MCCON_SET = ((uint32_t)(0x80000000));
	} else {
		MCPWMx->MCCON_CLR = ((uint32_t)(0x80000000));
	}

	if (outputInvered) {
		MCPWMx->MCCON_SET = ((uint32_t)(1<<29));
	} else {
		MCPWMx->MCCON_CLR = ((uint32_t)(1<<29));
	}
