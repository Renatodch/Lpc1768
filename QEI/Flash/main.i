...
#line 9 "Src\\main.c"
#line 1 ".\\Lib\\Usb_Drivers\\Inc\\vcomdemo.h"
...
#line 29 ".\\Lib\\Usb_Drivers\\Inc\\vcomdemo.h"
...
char Buffer_RAM1[32000];
char Buffer_RAM2[768];
...
int test(char *msg)
{
  ...
  char Buffer_t[100]={0}; 
	...
	memcpy(Buffer_t,p,sizeof(Buffer_t));
	return 1;
}
...
int main (void)
{
	...
	while(1)
	{
		memset(Buffer_RAM1,0xFF,sizeof(Buffer_RAM1));
		test(Buffer_RAM1);
