...
#line 1 ".\\Lib\\Drivers\\include\\lpc17xx_nvic.h"
...
#line 45 ".\\Lib\\Drivers\\include\\lpc17xx_nvic.h"
...
#line 46 ".\\Lib\\Drivers\\include\\lpc17xx_nvic.h"
...
#line 41 "Lib\\Drivers\\source\\lpc17xx_nvic.c"
...
void NVIC_DeInit(void)
{
	...
	((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ICER[1] = 0x00000001;
	 
	((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ICPR[0] = 0xFFFFFFFF;
	((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ICPR[1] = 0x00000001;

	 
	for (tmp = 0; tmp < 32; tmp++) {
		((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->IP[tmp] = 0x00;
	}
}
...
void NVIC_SCBDeInit(void)
{
	...
	((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->ICSR = 0x0A000000;
	((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->VTOR = 0x00000000;
	((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->AIRCR = 0x05FA0000;
	((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR = 0x00000000;
	((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->CCR = 0x00000000;

	for (tmp = 0; tmp < 32; tmp++) {
		((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SHP[tmp] = 0x00;
	}

	((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SHCSR = 0x00000000;
	((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->CFSR = 0xFFFFFFFF;
	((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->HFSR = 0xFFFFFFFF;
	((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->DFSR = 0xFFFFFFFF;
}
...
void NVIC_SetVTOR(uint32_t offset)
{
	...
	((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->VTOR  = offset;
}
