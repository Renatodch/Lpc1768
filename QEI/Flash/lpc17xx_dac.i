...
#line 1 ".\\Lib\\Drivers\\include\\lpc17xx_dac.h"
...
#line 44 ".\\Lib\\Drivers\\include\\lpc17xx_dac.h"
...
#line 45 ".\\Lib\\Drivers\\include\\lpc17xx_dac.h"
...
#line 39 "Lib\\Drivers\\source\\lpc17xx_dac.c"
...
#line 40 "Lib\\Drivers\\source\\lpc17xx_dac.c"
...
#line 49 "Lib\\Drivers\\source\\lpc17xx_dac.c"
...
void DAC_Init(LPC_DAC_TypeDef *DACx)
{
	(((((uint32_t *)DACx)==((uint32_t *)((LPC_DAC_TypeDef *) ((0x40080000UL) + 0x0C000) )))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_dac.c", 68));
	 
	
	
	DAC_SetBias(((LPC_DAC_TypeDef *) ((0x40080000UL) + 0x0C000) ),DAC_MAX_CURRENT_700uA);
}
...
{
	uint32_t tmp;
	(((((uint32_t *)DACx)==((uint32_t *)((LPC_DAC_TypeDef *) ((0x40080000UL) + 0x0C000) )))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_dac.c", 84));
	tmp = DACx->DACR & ((uint32_t)(1<<16));
	tmp |= ((uint32_t)((dac_value&0x3FF)<<6));
...
void DAC_SetBias (LPC_DAC_TypeDef *DACx,uint32_t bias)
{
	((((bias == DAC_MAX_CURRENT_700uA)||(bias == DAC_MAX_CURRENT_350uA))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_dac.c", 100));
	DACx->DACR &=~((uint32_t)(1<<16));
...
void DAC_ConfigDAConverterControl (LPC_DAC_TypeDef *DACx,DAC_CONVERTER_CFG_Type *DAC_ConverterConfigStruct)
{
	(((((uint32_t *)DACx)==((uint32_t *)((LPC_DAC_TypeDef *) ((0x40080000UL) + 0x0C000) )))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_dac.c", 119));
	DACx->DACCTRL &= ~((uint32_t)(0x0F));
	if (DAC_ConverterConfigStruct->DBLBUF_ENA)
		DACx->DACCTRL	|= ((uint32_t)(1<<1));
	if (DAC_ConverterConfigStruct->CNT_ENA)
		DACx->DACCTRL	|= ((uint32_t)(1<<2));
	if (DAC_ConverterConfigStruct->DMA_ENA)
		DACx->DACCTRL	|= ((uint32_t)(1<<3));
}
...
void DAC_SetDMATimeOut(LPC_DAC_TypeDef *DACx, uint32_t time_out)
{
	(((((uint32_t *)DACx)==((uint32_t *)((LPC_DAC_TypeDef *) ((0x40080000UL) + 0x0C000) )))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_dac.c", 137));
	DACx->DACCNTVAL = ((uint32_t)(time_out&0xffff));
}
