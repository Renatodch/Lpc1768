...
#line 1 ".\\Lib\\Drivers\\include\\lpc17xx_spi.h"
...
#line 44 ".\\Lib\\Drivers\\include\\lpc17xx_spi.h"
...
#line 45 ".\\Lib\\Drivers\\include\\lpc17xx_spi.h"
...
#line 86 ".\\Lib\\Drivers\\include\\lpc17xx_spi.h"
...
#line 39 "Lib\\Drivers\\source\\lpc17xx_spi.c"
...
#line 40 "Lib\\Drivers\\source\\lpc17xx_spi.c"
...
#line 49 "Lib\\Drivers\\source\\lpc17xx_spi.c"
...
void SPI_SetClock (LPC_SPI_TypeDef *SPIx, uint32_t target_clock)
{
	...
	(((((uint32_t *)SPIx)==((uint32_t *)((LPC_SPI_TypeDef *) ((0x40000000UL) + 0x20000) )))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_spi.c", 70));

	if (SPIx == ((LPC_SPI_TypeDef *) ((0x40000000UL) + 0x20000) )){
		spi_pclk =  CLKPWR_GetPCLK (((uint32_t)(16)));
	} else {
		return;
	}
	...
	SPIx->SPCCR = ((uint32_t)(prescale&0xFF));
}
...
void SPI_DeInit(LPC_SPI_TypeDef *SPIx)
{
	(((((uint32_t *)SPIx)==((uint32_t *)((LPC_SPI_TypeDef *) ((0x40000000UL) + 0x20000) )))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_spi.c", 104));
...
uint8_t SPI_GetDataSize (LPC_SPI_TypeDef *SPIx)
{
	(((((uint32_t *)SPIx)==((uint32_t *)((LPC_SPI_TypeDef *) ((0x40000000UL) + 0x20000) )))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_spi.c", 119));
...
void SPI_Init(LPC_SPI_TypeDef *SPIx, SPI_CFG_Type *SPI_ConfigStruct)
{
	...
	(((((uint32_t *)SPIx)==((uint32_t *)((LPC_SPI_TypeDef *) ((0x40000000UL) + 0x20000) )))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_spi.c", 136));
	...
	tmp = ((SPI_ConfigStruct->CPHA) | (SPI_ConfigStruct->CPOL) 		| (SPI_ConfigStruct->DataOrder) | (SPI_ConfigStruct->Databit) 		| (SPI_ConfigStruct->Mode) | ((uint32_t)(1<<2))) & ((uint32_t)(0xFFC));
	...
	if (SPIx->SPINT & ((uint32_t)(1<<0))){
		SPIx->SPINT = ((uint32_t)(1<<0));
	}
}
...
void SPI_ConfigStructInit(SPI_CFG_Type *SPI_InitStruct)
{
	SPI_InitStruct->CPHA = ((uint32_t)(0));
	SPI_InitStruct->CPOL = ((uint32_t)(0));
	SPI_InitStruct->ClockRate = 1000000;
	SPI_InitStruct->DataOrder = ((uint32_t)(0));
	SPI_InitStruct->Databit = ((0x08==0) ? ((uint32_t)0) : ((uint32_t)((0x08&0x0F)<<8)));
	SPI_InitStruct->Mode = ((uint32_t)(1<<5));
}
...
void SPI_SendData(LPC_SPI_TypeDef* SPIx, uint16_t Data)
{
	(((((uint32_t *)SPIx)==((uint32_t *)((LPC_SPI_TypeDef *) ((0x40000000UL) + 0x20000) )))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_spi.c", 194));

	SPIx->SPDR = Data & ((uint32_t)(0xFFFF));
}
...
uint16_t SPI_ReceiveData(LPC_SPI_TypeDef* SPIx)
{
	(((((uint32_t *)SPIx)==((uint32_t *)((LPC_SPI_TypeDef *) ((0x40000000UL) + 0x20000) )))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_spi.c", 208));

	return ((uint16_t) (SPIx->SPDR & ((uint32_t)(0xFFFF))));
}
...

{
	...
	if (xfType == SPI_TRANSFER_POLLING){
		...
		while(dataCfg->counter < dataCfg->length)
		{
			...
			while (!((stat = SPIx->SPSR) & ((uint32_t)(1<<7))));
			
			if (stat & (((uint32_t)(1<<3)) | ((uint32_t)(1<<4)) | ((uint32_t)(1<<5)) | ((uint32_t)(1<<6)))){
...
void SPI_IntCmd(LPC_SPI_TypeDef *SPIx, FunctionalState NewState)
{
	(((((uint32_t *)SPIx)==((uint32_t *)((LPC_SPI_TypeDef *) ((0x40000000UL) + 0x20000) )))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_spi.c", 354));
	((((NewState==DISABLE) || (NewState==ENABLE))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_spi.c", 355));

	if (NewState == ENABLE)
	{
		SPIx->SPCR |= ((uint32_t)(1<<7));
	}
	else
	{
		SPIx->SPCR &= (~((uint32_t)(1<<7))) & ((uint32_t)(0xFFC));
	}
}
...
IntStatus SPI_GetIntStatus (LPC_SPI_TypeDef *SPIx)
{
	(((((uint32_t *)SPIx)==((uint32_t *)((LPC_SPI_TypeDef *) ((0x40000000UL) + 0x20000) )))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_spi.c", 375));

	return ((SPIx->SPINT & ((uint32_t)(1<<0))) ? SET : RESET);
}
...
void SPI_ClearIntPending(LPC_SPI_TypeDef *SPIx)
{
	(((((uint32_t *)SPIx)==((uint32_t *)((LPC_SPI_TypeDef *) ((0x40000000UL) + 0x20000) )))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_spi.c", 387));
...
uint32_t SPI_GetStatus(LPC_SPI_TypeDef* SPIx)
{
	(((((uint32_t *)SPIx)==((uint32_t *)((LPC_SPI_TypeDef *) ((0x40000000UL) + 0x20000) )))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_spi.c", 406));

	return (SPIx->SPSR & ((uint32_t)(0xF8)));
}
...
FlagStatus SPI_CheckStatus (uint32_t inputSPIStatus,  uint8_t SPIStatus)
{
	((((SPIStatus==((uint32_t)(1<<3))) || (SPIStatus==((uint32_t)(1<<4))) || (SPIStatus==((uint32_t)(1<<5))) || (SPIStatus==((uint32_t)(1<<6))) || (SPIStatus==((uint32_t)(1<<7))))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_spi.c", 427));
