...
#line 23 "Lib\\Usb_Drivers\\Src\\usbhw.c"
...
#line 24 "Lib\\Usb_Drivers\\Src\\usbhw.c"
...
#line 25 "Lib\\Usb_Drivers\\Src\\usbhw.c"
#line 1 ".\\Lib\\Usb_Drivers\\Inc\\usbreg.h"
...
#line 33 ".\\Lib\\Usb_Drivers\\Inc\\usbreg.h"
...
#line 67 ".\\Lib\\Usb_Drivers\\Inc\\usbreg.h"
...
#line 83 ".\\Lib\\Usb_Drivers\\Inc\\usbreg.h"
...
#line 104 ".\\Lib\\Usb_Drivers\\Inc\\usbreg.h"

 
#line 113 ".\\Lib\\Usb_Drivers\\Inc\\usbreg.h"
...
#line 26 "Lib\\Usb_Drivers\\Src\\usbhw.c"
...
#line 27 "Lib\\Usb_Drivers\\Src\\usbhw.c"
...
#line 28 "Lib\\Usb_Drivers\\Src\\usbhw.c"
...
#line 29 "Lib\\Usb_Drivers\\Src\\usbhw.c"
...
#line 53 "Lib\\Usb_Drivers\\Src\\usbhw.c"
...
void WrCmd (uint32_t cmd) {
  ...
  ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBDevIntClr = 0x00000010;
  ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBCmdCode = cmd;
  while ((((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBDevIntSt & 0x00000010) == 0);
}
...
void WrCmdDat (uint32_t cmd, uint32_t val) {
  ...
  while ((((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBDevIntSt & 0x00000010) == 0);
  ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBDevIntClr = 0x00000010;
  ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBCmdCode = val;
  while ((((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBDevIntSt & 0x00000010) == 0);
}
...
void WrCmdEP (uint32_t EPNum, uint32_t cmd){
  ...
  ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBDevIntClr = 0x00000010;
  ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBCmdCode = (0x00000500 | ((EPAdr(EPNum)) << 16));
  while ((((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBDevIntSt & 0x00000010) == 0);
  ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBDevIntClr = 0x00000010;
  ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBCmdCode = cmd;
  while ((((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBDevIntSt & 0x00000010) == 0);
...
uint32_t RdCmdDat (uint32_t cmd) {
  ...
  ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBDevIntClr = 0x00000010 | 0x00000020;
  ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBCmdCode = cmd;
  while ((((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBDevIntSt & 0x00000020) == 0);
  return (((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBCmdData);
}
...
void USB_Init (void) {
  ...
  ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBClkCtrl = 0x1A;                 
  while ((((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBClkSt & 0x1A) != 0x1A);
...
void USB_Reset (void) {
  ...
  ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBEpInd = 0;
  ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBMaxPSize = 8;
  ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBEpInd = 1;
  ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBMaxPSize = 8;
  while ((((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBDevIntSt & 0x00000100) == 0);

  ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBEpIntClr  = 0xFFFFFFFF;
  ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBEpIntEn   = 0xFFFFFFFF ^ 0x00000000;
  ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBDevIntClr = 0xFFFFFFFF;
  ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBDevIntEn  = 0x00000008    | 0x00000004    |
               (0   ? 0x00000001 : 0) |
               (0 ? 0x00000200   : 0);

#line 220 "Lib\\Usb_Drivers\\Src\\usbhw.c"
}
...
void USB_Configure (uint32_t cfg) {
  ...
  ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBReEp = 0x00000003;
  while ((((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBDevIntSt & 0x00000100) == 0);
  ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBDevIntClr = 0x00000100;
}
...
void USB_ConfigEP (USB_ENDPOINT_DESCRIPTOR *pEPD) {
  ...
  ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBReEp |= (1 << num);
  ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBEpInd = num;
  ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBMaxPSize = pEPD->wMaxPacketSize;
  while ((((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBDevIntSt & 0x00000100) == 0);
  ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBDevIntClr = 0x00000100;
}
...
uint32_t USB_ReadEP (uint32_t EPNum, uint8_t *pData) {
  ...
  ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBCtrl = ((EPNum & 0x0F) << 2) | 0x00000001;

  do {
    cnt = ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBRxPLen;
  } while ((cnt & 0x00000800) == 0);
  cnt &= 0x000003FF;

  for (n = 0; n < (cnt + 3) / 4; n++) {
    *((__packed uint32_t *)pData) = ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBRxData;
    pData += 4;
  }
  ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBCtrl = 0;
...
uint32_t USB_WriteEP (uint32_t EPNum, uint8_t *pData, uint32_t cnt) {
  ...
  ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBCtrl = ((EPNum & 0x0F) << 2) | 0x00000002;

  ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBTxPLen = cnt;

  for (n = 0; n < (cnt + 3) / 4; n++) {
    ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBTxData = *((__packed uint32_t *)pData);
    pData += 4;
  }
  ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBCtrl = 0;
...
#line 635 "Lib\\Usb_Drivers\\Src\\usbhw.c"
...
void USB_IRQHandler (void) {
  ...
  disr = ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBDevIntSt;        

   
  if (disr & 0x00000008) {
    ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBDevIntClr = 0x00000008;
    WrCmd(0x00FE0500);
...
#line 703 "Lib\\Usb_Drivers\\Src\\usbhw.c"

#line 713 "Lib\\Usb_Drivers\\Src\\usbhw.c"

   
  if (disr & 0x00000004) {
    episrCur = 0;
    episr    = ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBEpIntSt;
    for (n = 0; n < 32; n++) {       
      ...
      if (episr & (1 << n)) {
        ...
        ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBEpIntClr = (1 << n);
        while ((((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBDevIntSt & 0x00000020) == 0);
        val = ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBCmdData;
    ...
    ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBDevIntClr = 0x00000004;
  }

#line 810 "Lib\\Usb_Drivers\\Src\\usbhw.c"
