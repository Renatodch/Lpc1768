...
#line 1 ".\\Lib\\Drivers\\include\\lpc17xx_gpio.h"
...
#line 44 ".\\Lib\\Drivers\\include\\lpc17xx_gpio.h"
...
#line 45 ".\\Lib\\Drivers\\include\\lpc17xx_gpio.h"
...
#line 40 "Lib\\Drivers\\source\\lpc17xx_gpio.c"
...
#line 49 "Lib\\Drivers\\source\\lpc17xx_gpio.c"
...
static LPC_GPIO_TypeDef *GPIO_GetPointer(uint8_t portNum)
{
	...
	switch (portNum) {
	case 0:
		pGPIO = ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) );
		break;
	case 1:
		pGPIO = ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) );
		break;
	case 2:
		pGPIO = ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) );
		break;
	case 3:
		pGPIO = ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00060) );
		break;
	case 4:
		pGPIO = ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00080) );
		break;
	default:
		break;
	}
...
static GPIO_HalfWord_TypeDef *FIO_HalfWordGetPointer(uint8_t portNum)
{
	...
	switch (portNum) {
	case 0:
		pFIO = ((GPIO_HalfWord_TypeDef *)(((0x2009C000UL) + 0x00000)));
		break;
	case 1:
		pFIO = ((GPIO_HalfWord_TypeDef *)(((0x2009C000UL) + 0x00020)));
		break;
	case 2:
		pFIO = ((GPIO_HalfWord_TypeDef *)(((0x2009C000UL) + 0x00040)));
		break;
	case 3:
		pFIO = ((GPIO_HalfWord_TypeDef *)(((0x2009C000UL) + 0x00060)));
		break;
	case 4:
		pFIO = ((GPIO_HalfWord_TypeDef *)(((0x2009C000UL) + 0x00080)));
		break;
	default:
		break;
	}
...
static GPIO_Byte_TypeDef *FIO_ByteGetPointer(uint8_t portNum)
{
	...
	switch (portNum) {
	case 0:
		pFIO = ((GPIO_Byte_TypeDef *)(((0x2009C000UL) + 0x00000)));
		break;
	case 1:
		pFIO = ((GPIO_Byte_TypeDef *)(((0x2009C000UL) + 0x00020)));
		break;
	case 2:
		pFIO = ((GPIO_Byte_TypeDef *)(((0x2009C000UL) + 0x00040)));
		break;
	case 3:
		pFIO = ((GPIO_Byte_TypeDef *)(((0x2009C000UL) + 0x00060)));
		break;
	case 4:
		pFIO = ((GPIO_Byte_TypeDef *)(((0x2009C000UL) + 0x00080)));
		break;
	default:
		break;
	}
