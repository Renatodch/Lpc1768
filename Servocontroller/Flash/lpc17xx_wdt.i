...
#line 1 ".\\Lib\\Drivers\\include\\lpc17xx_wdt.h"
...
#line 44 ".\\Lib\\Drivers\\include\\lpc17xx_wdt.h"
...
#line 45 ".\\Lib\\Drivers\\include\\lpc17xx_wdt.h"
...
#line 40 "Lib\\Drivers\\source\\lpc17xx_wdt.c"
...
#line 41 "Lib\\Drivers\\source\\lpc17xx_wdt.c"
...
#line 42 "Lib\\Drivers\\source\\lpc17xx_wdt.c"
...
#line 52 "Lib\\Drivers\\source\\lpc17xx_wdt.c"
...
static uint8_t WDT_SetTimeOut (uint8_t clk_source, uint32_t timeout)
{
    ...
    case WDT_CLKSRC_IRC:
    	...
    	tempval  = ((((uint64_t)pclk_wdt * (uint64_t)timeout / 4) / (uint64_t)((uint32_t)(1000000))));
    	
    	if (tempval >= ((uint32_t)(0xFF)))
    	{
    		((LPC_WDT_TypeDef *) ((0x40000000UL) + 0x00000) )->WDTC = tempval;
    		return	SUCCESS;
    	}
    ...
    case WDT_CLKSRC_PCLK:
		...
		if (tempval >= ((uint32_t)(0xFF)))
		{
			CLKPWR_SetPCLKDiv (((uint32_t)(0)), ((uint32_t)(0)));
			((LPC_WDT_TypeDef *) ((0x40000000UL) + 0x00000) )->WDTC = (uint32_t) tempval;
			return SUCCESS;
		}
		...
		if (tempval >= ((uint32_t)(0xFF)))
		{
			CLKPWR_SetPCLKDiv (((uint32_t)(0)), ((uint32_t)(2)));
			((LPC_WDT_TypeDef *) ((0x40000000UL) + 0x00000) )->WDTC = (uint32_t) tempval;
			return	SUCCESS;
		}
		...
		if (tempval >= ((uint32_t)(0xFF)))
		{
			CLKPWR_SetPCLKDiv (((uint32_t)(0)), ((uint32_t)(1)));
			((LPC_WDT_TypeDef *) ((0x40000000UL) + 0x00000) )->WDTC = (uint32_t) tempval;
			return	SUCCESS;
		}
		break ;
...
void WDT_Init (WDT_CLK_OPT ClkSrc, WDT_MODE_OPT WDTMode)
{
	((((ClkSrc ==WDT_CLKSRC_IRC)||(ClkSrc ==WDT_CLKSRC_PCLK)||(ClkSrc ==WDT_CLKSRC_RTC))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_wdt.c", 172));
	((((WDTMode ==WDT_MODE_INT_ONLY)||(WDTMode ==WDT_MODE_RESET))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_wdt.c", 173));
	CLKPWR_SetPCLKDiv (((uint32_t)(0)), ((uint32_t)(0)));

	
	((LPC_WDT_TypeDef *) ((0x40000000UL) + 0x00000) )->WDCLKSEL &= ~(uint8_t)(0x03);
	((LPC_WDT_TypeDef *) ((0x40000000UL) + 0x00000) )->WDCLKSEL |= ClkSrc;
	
	if (WDTMode == WDT_MODE_RESET){
		((LPC_WDT_TypeDef *) ((0x40000000UL) + 0x00000) )->WDMOD |= ((uint32_t)(1<<1));
	}
}
...
void WDT_Start(uint32_t TimeOut)
{
	...
	ClkSrc = ((LPC_WDT_TypeDef *) ((0x40000000UL) + 0x00000) )->WDCLKSEL;
	ClkSrc &=(uint8_t)(0x03);
	WDT_SetTimeOut(ClkSrc,TimeOut);
	
	((LPC_WDT_TypeDef *) ((0x40000000UL) + 0x00000) )->WDMOD |= ((uint32_t)(1<<0));
	WDT_Feed();
}
...
FlagStatus WDT_ReadTimeOutFlag (void)
{
	return ((FlagStatus)((((LPC_WDT_TypeDef *) ((0x40000000UL) + 0x00000) )->WDMOD & ((uint32_t)(1<<2))) >>2));
}
...
void WDT_ClrTimeOutFlag (void)
{
	((LPC_WDT_TypeDef *) ((0x40000000UL) + 0x00000) )->WDMOD &=~((uint32_t)(1<<2));
}
...
uint32_t WDT_GetCurrentCount(void)
{
	return ((LPC_WDT_TypeDef *) ((0x40000000UL) + 0x00000) )->WDTV;
}
