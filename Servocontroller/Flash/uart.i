...
#line 17 "Lib\\Usb_Drivers\\Src\\uart.c"
...
#line 18 "Lib\\Usb_Drivers\\Src\\uart.c"
...
#line 19 "Lib\\Usb_Drivers\\Src\\uart.c"
...
#line 34 "Lib\\Usb_Drivers\\Src\\uart.c"
...
void ser_ClosePort (char portNum ) {
  if ( portNum == 0 )
  {
	...
	((LPC_UART_TypeDef *) ((0x40000000UL) + 0x0C000) )->IER = 0;
	NVIC_DisableIRQ(UART0_IRQn);
  }
  else
  {
...
void ser_InitPort0 (unsigned long baudrate, unsigned int  databits,
  ...
  (ser_out . rdIdx = ser_out . wrIdx = 0);                              
  (ser_in . rdIdx = ser_in . wrIdx = 0);                               
  ...
  ((LPC_UART_TypeDef *) ((0x40000000UL) + 0x0C000) )->FDR = 0;                             
  ((LPC_UART_TypeDef *) ((0x40000000UL) + 0x0C000) )->LCR = 0x80 | lcr_d | lcr_p | lcr_s;  
  ((LPC_UART_TypeDef *) ((0x40000000UL) + 0x0C000) )->DLL = dll;                           
  ((LPC_UART_TypeDef *) ((0x40000000UL) + 0x0C000) )->DLM = (dll >> 8);                    
  ((LPC_UART_TypeDef *) ((0x40000000UL) + 0x0C000) )->LCR = 0x00 | lcr_d | lcr_p | lcr_s;  
  ((LPC_UART_TypeDef *) ((0x40000000UL) + 0x0C000) )->IER = 0x03;                          

  ((LPC_UART_TypeDef *) ((0x40000000UL) + 0x0C000) )->FCR = 0x07;				 
  ser_txRestart = 1;                                   
...
void ser_InitPort1 (unsigned long baudrate, unsigned int  databits,
  ...
  dll = (pclk/16)/baudrate ;	 
  ((LPC_UART1_TypeDef *) ((0x40000000UL) + 0x10000) )->FDR = 0;                             
  ((LPC_UART1_TypeDef *) ((0x40000000UL) + 0x10000) )->LCR = 0x80 | lcr_d | lcr_p | lcr_s;  
  ((LPC_UART1_TypeDef *) ((0x40000000UL) + 0x10000) )->DLL = dll;                           
  ((LPC_UART1_TypeDef *) ((0x40000000UL) + 0x10000) )->DLM = (dll >> 8);                    
  ((LPC_UART1_TypeDef *) ((0x40000000UL) + 0x10000) )->LCR = 0x00 | lcr_d | lcr_p | lcr_s;  
  ((LPC_UART1_TypeDef *) ((0x40000000UL) + 0x10000) )->IER = 0x03;                          
...
int ser_Read (char *buffer, const int *length) {
  ...
  while (bytesToRead--) {
    while ((ser_in . rdIdx == ser_in . wrIdx));                     
    *buffer++ = (ser_in . data[((128)-1ul) & ser_in . rdIdx++]);
  }
  return (bytesRead);
}
...
int ser_Write (char portNum, const char *buffer, int *length) {
  ...
  while (!(ser_out . rdIdx == ser_out . wrIdx));               
  while (bytesToWrite) {
      (ser_out . data[((128)-1ul) & ser_out . wrIdx++] = (*buffer++));            
      bytesToWrite--;
  }
  ...
  if (ser_txRestart) {
	...
	if ( portNum == 0 )
	{
	  ((LPC_UART_TypeDef *) ((0x40000000UL) + 0x0C000) )->THR = (ser_out . data[((128)-1ul) & ser_out . rdIdx++]);             
    }
	else
	{
      ((LPC_UART1_TypeDef *) ((0x40000000UL) + 0x10000) )->THR = (ser_out . data[((128)-1ul) & ser_out . rdIdx++]);             
	}
  }
...
void ser_AvailChar (int *availChar) {
  ...
  *availChar = (((128)-1ul) & (ser_in . wrIdx - ser_in . rdIdx));
...
void UART0_IRQHandler(void)
{
  ...
  iir = ((LPC_UART_TypeDef *) ((0x40000000UL) + 0x0C000) )->IIR;

  if ((iir & 0x4) || (iir & 0xC)) {            
    while (((LPC_UART_TypeDef *) ((0x40000000UL) + 0x0C000) )->LSR & 0x01) {                 
      (ser_in . data[((128)-1ul) & ser_in . wrIdx++] = (((LPC_UART_TypeDef *) ((0x40000000UL) + 0x0C000) )->RBR));           
    }
  }
  if ((iir & 0x2)) {                           
	if ((((128)-1ul) & (ser_out . wrIdx - ser_out . rdIdx)) != 0) {
      ((LPC_UART_TypeDef *) ((0x40000000UL) + 0x0C000) )->THR = (ser_out . data[((128)-1ul) & ser_out . rdIdx++]);         
      ser_txRestart = 0;
    }
	else {
  ...
  ser_lineState = ((LPC_UART_TypeDef *) ((0x40000000UL) + 0x0C000) )->LSR & 0x1E;            
  return;
}
...
void UART1_IRQHandler(void)
{
  ...
  iir = ((LPC_UART1_TypeDef *) ((0x40000000UL) + 0x10000) )->IIR;

  if ((iir & 0x4) || (iir & 0xC)) {            
    while (((LPC_UART1_TypeDef *) ((0x40000000UL) + 0x10000) )->LSR & 0x01) {                 
      (ser_in . data[((128)-1ul) & ser_in . wrIdx++] = (((LPC_UART1_TypeDef *) ((0x40000000UL) + 0x10000) )->RBR));           
    }
  }
  if ((iir & 0x2)) {                           
	if ((((128)-1ul) & (ser_out . wrIdx - ser_out . rdIdx)) != 0) {
  ...
  ser_lineState = ((((LPC_UART1_TypeDef *) ((0x40000000UL) + 0x10000) )->MSR<<8)|((LPC_UART1_TypeDef *) ((0x40000000UL) + 0x10000) )->LSR) & 0xE01E;    
  return;
}
