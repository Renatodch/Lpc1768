...
#line 40 "Lib\\Drivers\\source\\lpc17xx_pinsel.c"
...
static void set_PinFunc ( uint8_t portnum, uint8_t pinnum, uint8_t funcnum)
{
	...
	uint32_t *pPinCon = (uint32_t *)&((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL0;
...
void set_ResistorMode ( uint8_t portnum, uint8_t pinnum, uint8_t modenum)
{
	...
	uint32_t *pPinCon = (uint32_t *)&((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINMODE0;
...
{
	uint32_t *pPinCon = (uint32_t *)&((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINMODE_OD0;
...
{
	if (NewState == ENABLE) {
		((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL10 |= (0x01UL << 3);
...
void PINSEL_SetI2C0Pins(uint8_t i2cPinMode, FunctionalState filterSlewRateEnable)
{
	...
	((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->I2CPADCFG = regVal;
}
