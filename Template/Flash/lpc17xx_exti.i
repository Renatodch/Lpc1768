#line 1 "Lib\\Drivers\\source\\lpc17xx_exti.c"
...
#line 1 ".\\Lib\\Drivers\\include\\lpc17xx_exti.h"
...
#line 44 ".\\Lib\\Drivers\\include\\lpc17xx_exti.h"
...
#line 45 ".\\Lib\\Drivers\\include\\lpc17xx_exti.h"
...
#line 40 "Lib\\Drivers\\source\\lpc17xx_exti.c"
...
#line 49 "Lib\\Drivers\\source\\lpc17xx_exti.c"
...
void EXTI_Init(void)
{
	((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->EXTINT = 0xF;
	((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->EXTMODE = 0x0;
	((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->EXTPOLAR = 0x0;
}
...
void EXTI_Config(EXTI_InitTypeDef *EXTICfg)
{
	((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->EXTINT = 0x0;
...
void EXTI_SetMode(EXTI_LINE_ENUM EXTILine, EXTI_MODE_ENUM mode)
{
	...
	{
		((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->EXTMODE |= (1 << EXTILine);
	}
...
void EXTI_SetPolarity(EXTI_LINE_ENUM EXTILine, EXTI_POLARITY_ENUM polarity)
{
	...
	{
		((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->EXTPOLAR |= (1 << EXTILine);
	}
...
void EXTI_ClearEXTIFlag(EXTI_LINE_ENUM EXTILine)
{
		((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->EXTINT = (1 << EXTILine);
}
