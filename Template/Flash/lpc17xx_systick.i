...
#line 1 ".\\Lib\\Drivers\\include\\lpc17xx_systick.h"
...
#line 44 ".\\Lib\\Drivers\\include\\lpc17xx_systick.h"
...
#line 45 ".\\Lib\\Drivers\\include\\lpc17xx_systick.h"
...
#line 40 "Lib\\Drivers\\source\\lpc17xx_systick.c"
...
#line 41 "Lib\\Drivers\\source\\lpc17xx_systick.c"
...
#line 50 "Lib\\Drivers\\source\\lpc17xx_systick.c"
...
void SYSTICK_InternalInit(uint32_t time)
{
	...
	else
	{
		...
		((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD = (cclk/1000)*time - 1;
	}
}
...
void SYSTICK_ExternalInit(uint32_t freq, uint32_t time)
{
	...
	else
	{
		...
		((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD = (freq/1000)*time - 1;
	}
}
...
void SYSTICK_Cmd(FunctionalState NewState)
{
	((((NewState==DISABLE) || (NewState==ENABLE))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_systick.c", 134));
...
void SYSTICK_IntCmd(FunctionalState NewState)
{
	((((NewState==DISABLE) || (NewState==ENABLE))) ? (void)0 : check_failed((uint8_t *)"Lib\\Drivers\\source\\lpc17xx_systick.c", 153));
