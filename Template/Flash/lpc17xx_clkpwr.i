...
#line 40 "Lib\\Drivers\\source\\lpc17xx_clkpwr.c"
...
void CLKPWR_SetPCLKDiv (uint32_t ClkType, uint32_t DivVal)
{
	...
	if (ClkType < 32)
	{
		...
		((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCLKSEL0 &= (~((0x03<<bitpos)));

		 
		((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCLKSEL0 |= ((DivVal<<bitpos));
	}
	 
	else
	{
		 
		((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCLKSEL1 &= ~((0x03<<bitpos));

		 
		((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCLKSEL1 |= ((DivVal<<bitpos));
	}
}
...
uint32_t CLKPWR_GetPCLKSEL (uint32_t ClkType)
{
	...
	{
		bitpos = ClkType;
		retval = ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCLKSEL0;
	}
	else
	{
		bitpos = ClkType - 32;
		retval = ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCLKSEL1;
	}

	retval = ((uint32_t)((retval>>bitpos)&0x03));
	return retval;
}
...
void CLKPWR_ConfigPPWR (uint32_t PPType, FunctionalState NewState)
{
	if (NewState == ENABLE)
	{
		((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCONP |= PPType & 0xEFEFF7DE;
	}
...
void CLKPWR_PowerDown(void)
{
	...
	((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR = 0x4;
	((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCON = 0x01;
